...
import {ReferencePage} from './pages/references/references';
import {HotlineDialerPage} from './pages/hotline-dialer/hotline-dialer';
  ...
  constructor(app, menu, platform) {
    ...
    if(window.innerWidth >= 768) {
      this.pages = [
        ...
        { title: 'Previous Concerns', component: SelectConcernPage },
        { title: 'References', component: ReferencePage },
        { title: 'Hotline Information', component: HotlineDialerPage }
      ];      
    }else {
      this.pages = [
        { title: 'Home', component: HomePage },
        ...
        { title: 'Previous Concerns', component: SelectConcernPage },
        { title: 'References', component: ReferencePage },
        { title: 'Call Hotline', component: HotlineDialerPage }
      ];   
    }
