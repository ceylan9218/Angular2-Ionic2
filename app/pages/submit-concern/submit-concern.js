...
export class SubmitConcernPage {
  static get parameters() {
    return [[ViewController], [NavParams], [NavController], [AuthenticateService], [ConcernService], [AlertController]];
  }

  constructor(viewCtrl, navParams, nav, authenticateService, concernService, alertCtrl) {
